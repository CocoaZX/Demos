...
- (void)viewDidLoad
{
    ...
    [backButton addTarget:self.navigationController action:@selector(popForBackController) forControlEvents:UIControlEventTouchUpInside];
    ...
    if (_isSendLocation) {
        ...
        [sendButton setTitleColor:[CommonUtils colorFromHexString:kLikeRedColor] forState:UIControlStateNormal];
