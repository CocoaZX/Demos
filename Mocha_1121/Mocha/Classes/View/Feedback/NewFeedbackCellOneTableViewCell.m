//
//  NewFeedbackCellOneTableViewCell.m
//  Mocha
//
...
@implementation NewFeedbackCellOneTableViewCell
...
{
    NSArray *array = [[NSBundle mainBundle] loadNibNamed:@"NewFeedbackCellOneTableViewCell" owner:self options:nil];
    NewFeedbackCellOneTableViewCell *cell = array[0];
